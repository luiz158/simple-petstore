...
public class CheckoutPageTest {
    ...
    restoresFormValues() throws Exception {
        AddressBuilder billingAddress = anAddress().
                withFirstName("Jack").withLastName("Johnson").withEmail("jack@gmail.com").withCountry("France").withStreet("QualityStreet");
        ...
        assertThat("billing information", checkoutPage, hasCheckoutForm(hasBillingInformation("Jack", "Johnson", "jack@gmail.com", "QualityStreet", "France")));
    ...
    @SuppressWarnings("unchecked")
    private Matcher<Element> hasBillingInformation(String firstName, String lastName, String email, String street, String country) {
