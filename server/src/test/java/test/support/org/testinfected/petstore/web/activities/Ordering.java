...
public class Ordering {
    ...
    public void confirm(String firstName, String lastName, String email, String cardType, String cardNumber, String cardExpiryDate, String city, String country) {
        CheckoutPage checkoutPage = petstore.goToCartPage().checkout();
        ReceiptPage receiptPage = checkoutPage.
                willBillTo(firstName, lastName, email, city, country).
    ...
    public void isBilledTo(String firstName, String lastName, String emailAddress, String city, String country) {
        petstore.goToReceiptPage(orderNumber).showsBillingInformation(firstName, lastName, emailAddress, city, country);
    }
}
