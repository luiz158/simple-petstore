...
public class ApplicationDriver {
    ...
    public void pay(String firstName, String lastName, String email, String cardType, String cardNumber, String cardExpiryDate, String city, String country) {
        user.loginAs(customer).order().confirm(firstName, lastName, email, cardType, cardNumber, cardExpiryDate, city, country);
    }
    ...
    public void showsBillingInformation(String firstName, String lastName, String emailAddress, String city, String country) {
        user.loginAs(customer).order().isBilledTo(firstName, lastName, emailAddress, city, country);
    }
}
